                ...
                stage('Integration Test') {
                    ...
                    parallel(
                            "testing startSandbox": {
                                ...
                                try {
                                    sandbox = colony.blueprint("demo trial","fasty-k8s", "testing_startSandbox", release,inputs, 5).startSandbox()
                            ...
                            "testing doInsideSandbox": {
                                colony.blueprint("demo trial", "fasty-k8s", "testing_doInsideSandbox", release,inputs, 5).doInsideSandbox() { sandbox_details ->
