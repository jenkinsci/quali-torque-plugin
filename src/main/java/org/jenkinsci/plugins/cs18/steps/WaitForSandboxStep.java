...
public class WaitForSandboxStep extends Step {
    ...
    @DataBoundSetter
    public void setSandboxId(String sandboxId, Integer timeout) {
        this.sandboxId = sandboxId;
        this.timeout = timeout;
    }
    ...
    public StepExecution start(StepContext stepContext) throws Exception {
        return new Execution(stepContext, getSandboxId(), getTimeout());
    }
    ...
    public static class Execution extends SandboxStepExecution<SingleSandbox> {
        ...
        public SingleSandbox waitForSandbox(String sandboxId, Integer timeoutMinutes) throws IOException, InterruptedException, TimeoutException {
